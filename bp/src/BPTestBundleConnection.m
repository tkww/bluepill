...
//    NSTask *task = [BPUtils buildShellTaskForCommand:command withPipe:nil];
    NSTask *task = [[NSTask alloc] init];
    task.launchPath = @"/usr/bin/xcrun";
    task.arguments = @[@"simctl", @"io", [self.simulator UDID], @"recordVideo", @"--force", videoFileName];
    task.standardOutput = NSFileHandle.fileHandleWithStandardOutput;
    task.standardError = NSFileHandle.fileHandleWithStandardOutput;
